...
public final class FordEmoji {

    static String ford = ":ford-6583:";
    static String ford_all = ":ford_all:";
    ...
    static List<String> getFordEmoji() {
        ArrayList<String> emojis = new ArrayList<>();
        emojis.add(ford);
        emojis.add(ford_all);
        emojis.add(ford_all_fast);
        emojis.add(ford_gt);
        emojis.add(dford);
        emojis.add(dorf);
        emojis.add(jim);
